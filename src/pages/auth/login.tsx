...
function Login(): JSX.Element {
  ...
  const handleGoogleSignIn = async (): Promise<void> => {
    try {
      ...
      router.push("/dashboard");
      console.log("User ID:", Cookies.get("uid"));
      ...
      <div className=" rounded-2xl shadow-2xl p-8  w-full max-w-md">
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <button
            ...
            className="bg-white hover:bg-gray-100 border font-semibold py-2 px-4 rounded-lg flex items-center justify-center transition-colors"
          >
            <svg
